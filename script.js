...
// // message.textContent = 'We use cookies for improved funtionality'
// message.innerHTML = 
// 'We use cookies for improved funtionality.<button class="btn btn--close-cookie">Got it!</button>';
...
// console.log(link.href);//relative url
...
// //Don't use//overides all existing classes
